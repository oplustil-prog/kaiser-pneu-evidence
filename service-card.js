(function () {
  ...
  function addEnhancedService(event) {
    ...
    if (typeof window.kaiserRequireAuth === "function" && !window.kaiserRequireAuth("ulozeni servisni karty")) return;
    ...
    saveState();
    window.setTimeout(() => window.kaiserSaveCloudNow?.({ visible: true, source: "Servisni karta" }), 80);
    form.reset();
